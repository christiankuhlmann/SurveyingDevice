...
const static bool DEBUG_BOOL_ARR[11] = {true,DEBUG_FILE_ENA, DEBUG_LIDAR_ENA, DEBUG_OLED_ENA, DEBUG_MAG_ENA, DEBUG_ACCEL_ENA, DEBUG_MAIN_ENA, DEBUG_LIDAR_EXTENDED_ENA, DEBUG_SENSOR_ENA, DEBUG_BLE_ENA, DEBUG_HEAP_ENA};
const static char DEBUG_STR_ARR[11][6] = {"SYS  ","FILE ", "LIDAR", "OLED ", "MAG  ", "ACCEL", "MAIN ", "LIDEX", "SENSR","BLE  ", "HEAP "};
